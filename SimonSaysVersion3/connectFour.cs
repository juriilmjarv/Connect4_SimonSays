...
namespace SimonSaysVersion3
{
    public partial class connectFour : Form
    {
        ...
        public connectFour()
        {
            ...
            playerTurn.SetBounds(240, 500, 120, 40);
        ...
        //Allows the player to drop thier piece on the reds turn
        bool dropRed()
        {
        ...
        //This is the computers moves which drops randomly somewhere across the game board
        void dropRandom()
        {
        ...
        //Displays computer win message and gives user option to restart or exit
